...
<body>
    ...
    <div data-react-class="Editor" data-react-props="{" data-react-cache-id="Editor-0">
        <div class="editor">
            <div class="editor_header"><a href="/admin/posts" class="button -small -secondary">Back</a><span id="editor_status" class="editor_status">Saved</span><a id="publish" class="button -small">Publish</a>

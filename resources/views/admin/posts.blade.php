        ...
        <div class="container">
            <header class="header">
                ...
                <nav class="nav">
                    ...
                    <nav class="nav">
                        <a class="nav_item -active" aria-current="page" href="/admin/posts">Posts</a>
                        <a class="nav_item" href="/admin/pages">Pages</a>
            ...
            <div class="container max-eight padding-bottom-gigantic">
                ...
                <ul class="list">
                    ...
                    <li class="list_item">
                        <a href="/admin/posts/{{ $post->sid }}" class="list_link">
                            @if($post->title==NULL)
